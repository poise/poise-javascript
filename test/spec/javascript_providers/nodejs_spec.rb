...
describe PoiseJavascript::JavascriptProviders::NodeJS do
  ...
  context 'with 32-bit OS' do
    ...
    it_behaves_like 'nodejs provider', 'nodejs-0.12.7', 'https://nodejs.org/dist/v0.12.7/node-v0.12.7-linux-x86.tar.gz'
  ...
  context 'action :uninstall' do
    ...
    it { is_expected.to uninstall_poise_languages_static('/opt/nodejs-0.12.7') }
