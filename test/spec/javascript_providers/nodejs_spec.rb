...
describe PoiseJavascript::JavascriptProviders::NodeJS do
  ...
  context 'with version ""' do
    ...
    it_behaves_like 'nodejs provider', 'nodejs-8.9.4', 'https://nodejs.org/dist/v8.9.4/node-v8.9.4-linux-x64.tar.gz'
  ...
  context 'with 32-bit OS' do
    ...
    it_behaves_like 'nodejs provider', 'nodejs-8.9.4', 'https://nodejs.org/dist/v8.9.4/node-v8.9.4-linux-x86.tar.gz'
  ...
  context 'action :uninstall' do
    ...
    it { is_expected.to uninstall_poise_languages_static('/opt/nodejs-8.9.4') }
