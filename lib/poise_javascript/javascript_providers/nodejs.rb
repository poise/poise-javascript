  ...
  module JavascriptProviders
    class NodeJS < Base
      ...
      include PoiseLanguages::Static(
        versions: %w{4.4.0 5.8.0 5.7.1 5.6.0 5.5.0 5.4.1 5.3.0 5.2.0 5.1.1 5.0.0 4.3.2 4.2.6 4.1.1 4.0.0 0.12.7 0.11.16 0.10.40 0.9.12 0.8.28 0.7.12 0.6.21 0.5.10},
